        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className={`transform transition-all duration-1000 ${
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              مؤسسة إبراهيم أسعد لخدمات الإنترنت هي شركة رائدة في مجال تقديم الحلول الرقمية المبتكرة. 
              نحن نجمع بين الخبرة التقنية العميقة والإبداع في التصميم لنقدم لعملائنا أفضل الخدمات.
            </p>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              نؤمن بأن التكنولوجيا يجب أن تكون في خدمة الإنسان، ولذلك نركز على تطوير حلول تقنية 
              تلبي احتياجات عملائنا الفعلية وتساعدهم على تحقيق أهدافهم.
            </p>
